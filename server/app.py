...
# ============ ВАЖНО: Добавляем папку server в путь ============
...
from models import Player, Pack
...
def handle_game_action(data):
    try:
        ...
        print(f'Error in game_action: {e}')
...
def handle_match_finished(data):
    try:
        ...
        print(f'Error in match_finished: {e}')
